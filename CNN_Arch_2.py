# Conv2D (32,5,5) -> Conv2D (32,5,5) -> MaxPooling2D(2,2) -> DropOut (0.25)  -> Conv2D (64,3,3) -> Conv2D (64,3,3) -> MaxPooling2D(2,2,stride=2) -> DropOut (0.25)  -> Flatten -> Dense (256) -> DropOut(0.5) -> Dense (10)#
# Epochs 5
import numpy as np
import pandas as pd
